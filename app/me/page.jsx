  ...
  return (
    <div className='w-full min-h-screen bg-black-default flex items-center justify-center'>
      <div className='flex flex-col gap-10 text-yellow-100'>
        <h1 className='text-5xl font-extrabold text-center cursor-pointer' onClick={() => router.push('/')}>BRRDAN &nbsp;<span className='italic'>!!</span></h1>
        ...
        {tab.music && (
            <div className='grid grid-cols-3 gap-6'>
                {music.map((item, index) => (
                    <div key={index} className={`w-[384px] h-auto flex flex-col gap-3 group hover:cursor-pointer hover:relative`}>
